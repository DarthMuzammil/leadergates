  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="bg-[rgb(142,22,22)] text-white py-20">
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="p-6">
        ...
        <a
          ...
          className="w-full"
        >
          <Button className="w-auto bg-[rgb(142,22,22)] text-white hover:bg-blue-700 shadow-md">
            Make an Enquiry
          </Button>
